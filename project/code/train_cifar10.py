...
for epoch in range(n_epochs):
    ...
    for step, batch in enumerate(tqdm(dataloader)):
        ...
        if step % update_interval == 0 and step > 0:
            ...
            network.save('results/parameters/cifar10_network.pt')

            with open('results/parameters/cifar10_assignments.pickle', 'wb') as fp:
                cPickle.dump(assignments.detach().cpu().numpy(), fp, -1)

            with open('results/parameters/cifar10_proportions.pickle', 'wb') as fp:
